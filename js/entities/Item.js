// Itens (spec 4): saco de verba (base da Task 6, reconstruida aqui porque essa task ainda nao integrou neste
// branch), checkpoint e coxinha de saida (Task 9). Um grupo so: sem gravidade por padrao, o saco solto liga a sua.
OBP.Itens = class {
  ...
  // usado pelos blocos (Task 6, ainda nao ligada aqui): saco pula e cai na camada em vez de nascer parado.
